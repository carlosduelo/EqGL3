...
if(Equalizer_name)
  list(APPEND FIND_PACKAGES_DEFINES EQGL3_USE_EQUALIZER)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND EQGL3_DEPENDENT_LIBRARIES Equalizer)
  endif()
...
set(EQGL3_BUILD_DEBS autoconf;automake;avahi-daemon;bison;cmake;doxygen;flex;git;git-review;libavahi-client-dev;libboost-date-time-dev;libboost-filesystem-dev;libboost-program-options-dev;libboost-regex-dev;libboost-serialization-dev;libboost-system-dev;libboost-test-dev;libboost-thread-dev;libgl1-mesa-dev;libglewmx1.6-dev;libhwloc-dev;libibverbs-dev;libleveldb-dev;libopencv-dev;libopenmpi-dev;libopenscenegraph-dev;libqt4-dev;librdmacm-dev;libspnav-dev;libudt-dev;libx11-dev;openmpi-bin;pkg-config;subversion)
